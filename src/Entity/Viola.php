...
#[ORM\Entity(repositoryClass: ViolaRepository::class)]
class Viola
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Picture::class, mappedBy: 'viola', orphanRemoval: true)]
    ...
    public function removePicture(Picture $picture): static
    {
        if ($this->pictures->removeElement($picture)) {
            ...
            if ($picture->getViola() === $this) {
                $picture->setViola(null);
            }
        }
